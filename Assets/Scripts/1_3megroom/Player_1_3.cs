...
public class Player_1_3 : MonoBehaviour
{
    ...
    private room_control other_script;
    ...
    void Start()
    {
        ...
        other_script = other_player.GetComponent<room_control>();
        //如果是另一个小人，则换精灵(磁极，脚 ）
        if (!Isplayer1)
        {
